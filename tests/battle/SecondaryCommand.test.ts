...
describe('Secondary Command — learned-actives composition', () => {
  it('a Knight with Black Mage secondary surfaces both kits once both are learned', () => {
    ...
    expect(learnedActivesInJob(u.progression, 'knight')).toEqual(['power_break', 'speed_break', 'magic_break', 'stasis_sword', 'lightning_stab']);
    ...
    const secondary = u.secondaryJobId
      ...
      : [];
    expect(primary).toEqual(['power_break', 'speed_break', 'magic_break', 'stasis_sword', 'lightning_stab']);
