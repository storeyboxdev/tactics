...
export const JOB_DEFS: Record<string, JobDef> = {
  ...
  chemist: {
    ...
    learnableActives: ['phoenix_down', 'remedy'],
    learnableReactions: [], learnableSupports: [], learnableMovements: [],
  },
  ...
  knight: {
    ...
    learnableActives: ['power_break', 'speed_break', 'magic_break'],
  ...
  white_mage: {
    ...
    learnableActives: ['cure', 'cura', 'curaja', 'raise', 'regen', 'esuna', 'holy'],
  ...
  oracle: {
    ...
    growth: { hp:   4, mp:   8, pa:   2, ma:   7, speed:   1 },
    learnableActives: ['sleep', 'poison_spell', 'silence_song', 'paralyze', 'foxbird'],
    learnableReactions: [], learnableSupports: ['magic_defense_up'], learnableMovements: [],
  },
  ...
  geomancer: {
    ...
    learnableActives: ['pebble_blast', 'hell_ivy', 'local_quake', 'wind_slash'],
    learnableReactions: [], learnableSupports: [], learnableMovements: [],
  },
  lancer: {
