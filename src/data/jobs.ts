...
export const JOB_DEFS: Record<string, JobDef> = {
  ...
  squire: {
    id: 'squire', name: 'Squire', weapon: 'dagger',
    prereqs: [],
  ...
  chemist: {
    id: 'chemist', name: 'Chemist', weapon: 'dagger',
    prereqs: [],
  ...
  // ─── Tier 1: from Chemist ─────────────────────────────────────────────────
  white_mage: {
    id: 'white_mage', name: 'White Mage', weapon: 'staff',
  ...
  black_mage: {
    id: 'black_mage', name: 'Black Mage', weapon: 'rod',
    prereqs: [{ jobId: 'chemist', level: 2 }],
  ...
  monk: {
    id: 'monk', name: 'Monk', weapon: 'knuckle',
  ...
  thief: {
    id: 'thief', name: 'Thief', weapon: 'dagger',
  ...
  // ─── Tier 2: magic branch ─────────────────────────────────────────────────
  time_mage: {
    id: 'time_mage', name: 'Time Mage', weapon: 'rod',
  ...
  oracle: {
    id: 'oracle', name: 'Oracle', weapon: 'pole',
    ...
    growth: { hp:   4, mp:   8, pa:   2, ma:   7, speed:   1 },
    learnableActives: ['sleep', 'poison_spell', 'silence_song', 'paralyze', 'foxbird', 'berserk_touch', 'confuse', 'frog'],
    learnableReactions: [], learnableSupports: ['magic_defense_up'], learnableMovements: [],
  },

  // ─── Tier 3: physical specialists ─────────────────────────────────────────
  geomancer: {
    id: 'geomancer', name: 'Geomancer', weapon: 'pole',
  ...
  mediator: {
    id: 'mediator', name: 'Mediator', weapon: 'gun',
  ...
  summoner: {
    id: 'summoner', name: 'Summoner', weapon: 'rod',
  ...
  // ─── Tier 4: elite ────────────────────────────────────────────────────────
  samurai: {
    id: 'samurai', name: 'Samurai', weapon: 'katana',
    prereqs: [
  ...
  ninja: {
    ...
    // arrives later.
    id: 'ninja', name: 'Ninja', weapon: 'ninja_blade',
    prereqs: [
  ...
  calculator: {
    id: 'calculator', name: 'Calculator', weapon: 'staff',
    prereqs: [
  ...
  bard: {
    id: 'bard', name: 'Bard', weapon: 'instrument',
  ...
  dancer: {
    id: 'dancer', name: 'Dancer', weapon: 'cloth',
  ...
  mime: {
    id: 'mime', name: 'Mime', weapon: 'knuckle',
    prereqs: [
